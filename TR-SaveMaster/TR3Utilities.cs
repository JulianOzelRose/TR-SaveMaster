...
namespace TR_SaveMaster
{
    class TR3Utilities
    {
        ...
        private string GetCleanLvlName()
        {
            ...
            else if (lvlName.StartsWith("Caves Of Kaliya") || lvlName.StartsWith("Kaliya Höhlen")) return "Caves Of Kaliya";
            else if (lvlName.StartsWith("Nevada Desert") || lvlName.StartsWith("Wüste von Nevada")) return "Nevada Desert";
            ...
            else if (lvlName.StartsWith("Coastal Village") || lvlName.StartsWith("Küstendorf")) return "Coastal Village";
            ...
            else if (lvlName.StartsWith("Meteorite Cavern") || lvlName.StartsWith("Höhle des Meteoriten")) return "Meteorite Cavern";
